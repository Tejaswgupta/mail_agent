...
<#
.SYNOPSIS
    Build mail_agent.exe with embedded license key
.DESCRIPTION
    Generates a license key, injects the signing key, and builds a Windows EXE with Nuitka
.PARAMETER ClientId
...
Write-Host "`n==> Building EXE with Nuitka..." -ForegroundColor Cyan
